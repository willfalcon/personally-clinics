...
function fetch_field_options($request) {
  ...
  foreach($records as $record) {
    ...
    foreach($fields_array as $key => $value) {
      ...
      if ($key != 'Name of Clinic' && $key != 'Address' && $key != 'Phone Number' && $key != 'Website' && $key != 'Clinic Open?' && $key != 'Hours Open' && $key != 'Location' && $key != 'lat' && $key != 'lng') {
